...
namespace MyGame
{
    ...
    {
        public static LoadGameDetails LoadGameDetails { get; private set; }
        ...
        public static void LoadGame(LoadGameDetails loadGameDetails, bool showLoading = true,
